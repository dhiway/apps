...
A Portal into the CORD network. Provides a view and interaction layer from a browser.

This can be accessed as a hosted application via https://apps.cord.network.
...
1. Clone the repo locally, via `git clone https://github.com/dhiway/apps <optional local path>`
